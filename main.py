...
bot = telebot.TeleBot('5138167242:AAHxSXiy7LM5eSZ1o76kK91c6GrffGxq6i0')  # Создаем экземпляр бота
...
def get_text_messages(message):
    ...
    if cur_menu != None and ms_text in cur_menu.buttons:  # проверим, что команда относится к текущему меню
        ...
        elif ms_text == "Прислать арт" or ms_text == "/рисунок" or 'арт' in ms_text or 'art' in ms_text:  # .................................................................
            bot.send_message(chat_id, "Пыхчу...")
            artdone = 0
            while artdone == 0:
                try:
                    dir = "C:/Users/matve/Desktop/рисунки"
                    dir = dir.replace('/', "\\")
                    img = open((os.path.join(dir, random.choice(os.listdir(dir)))), 'rb')
                    key1 = types.InlineKeyboardMarkup()
                    btn1 = types.InlineKeyboardButton(text="хавай", url='t.me/SylorgyBot')
                    key1.add(btn1)
                    bot.send_photo(message.chat.id, img, reply_markup=key1)
                    artdone = 1
                except:
                    bot.send_message(chat_id, "Выбираю помалясь...")
                    artdone = 0
